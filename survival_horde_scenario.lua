...
ScenarioInfo = {
  ...
  size = {512, 512},
  map_version=5,
  map = '/maps/survival_horde.v0005/survival_horde.scmap',
  save = '/maps/survival_horde.v0005/survival_horde_save.lua',
  script = '/maps/survival_horde.v0005/survival_horde_script.lua',
  norushradius = 80,
  Configurations = {
    ['standard'] = {
      teams = {
